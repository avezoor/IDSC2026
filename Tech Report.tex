...
All 11 candidate models trained successfully in the reported pipeline. The aggregate winner and the safety-oriented winner are the same model, which is helpful rather than trivial: it means the top overall model also provided the strongest false-negative profile among the tested candidates on this split.
